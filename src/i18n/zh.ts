export const zh = {
  ...
  projects: {
    ...
    pageTitle: '项目',
    title: '研究与项目亮点',
    intro: '代表性学术、技术、课程与嵌入式系统项目，涵盖计算机视觉、三维重建、神经渲染、医学影像、创意编程与机器人系统。',
    fullTitle: '项目',
    indexTitle: '已索引作品',
    fullIntro: '学术、技术、课程与嵌入式系统项目，涵盖视觉计算、医学影像、创意编程与机器人系统等方向。',
    viewAll: '查看全部项目',
    filters: {
      all: '全部',
      vision: '三维视觉',
    ...
    index: {
      ...
      descriptions: {
        all: '八个学术、课程、研究与竞赛记录，覆盖视觉计算、医学影像、创意编程、概率建模与嵌入式系统。',
        ...
        coursework: '其中七个记录来自上海科技大学的真实课程项目。',
        'embedded-systems': '结合嵌入式控制、机器视觉与机电系统设计的软硬件系统。',
      },
    },
    labels: {
      details: '项目页面',
